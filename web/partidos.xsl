                ...
                <main>
                    ...
                    <table>
                        ...
                        <xsl:for-each select="partido">
                            ...
                            <xsl:variable name="ciudadPartido" select="lugar/@ciudad"/>
                            ...
                            <!-- Visualizará los equipos, la fecha y el resultado -->
                                <tr>
                                    <td><xsl:value-of select="lugar[$ciudadPartido]/../equipos/local"/> - <xsl:value-of select="lugar[$ciudadPartido]/../equipos/visitante"/></td>
                                    <td><xsl:value-of select="lugar[$ciudadPartido]/../fecha"/></td>
                                    
                                    <xsl:choose>
                                    <!-- Si gana el visitante lo mostrará en azul  -->
                                        <xsl:when test="equipos/visitante/@puntuacion &gt; equipos/local/@puntuacion">
                                            <td class="azul">
                                                <xsl:value-of select="lugar[$ciudadPartido]/../equipos/local/@puntuacion"/> - 
                                                <xsl:value-of select="lugar[$ciudadPartido]/../equipos/visitante/@puntuacion"/>
                                            </td>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <td>
