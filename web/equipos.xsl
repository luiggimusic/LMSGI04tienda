...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:template match="equipo">
        ...
        <!-- Selecciono al entrenador creando una variable asignándole el nombre del entrenador -->
        <xsl:variable name="nombreEnt" select="entrenador/nombre"/>
        
        <!-- Asigno el nombre "Julio Velasco" a la variable -->
        <xsl:if test="entrenador/nombre = 'Julio Velasco'">
            
            <!-- Se muestra el nombre del entrenador -->
            <h1><a href="{entrenador/url}"><xsl:value-of select="$nombreEnt"/></a></h1>
